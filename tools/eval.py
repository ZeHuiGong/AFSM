...
def main():
    ...
    if cor_or_cen:
        multi_scale_test = getattr(cfg, 'CornerMultiscaleTest', None)
    else:
    ...
    with fluid.program_guard(eval_prog, startup_prog):
        with fluid.unique_name.guard():
            ...
            if cor_or_cen and multi_scale_test:
                inputs_def['test_scales'] = [FLAGS.test_scales]
                cfg['EvalReader']['sample_transforms'][1].test_scales = [FLAGS.test_scales]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help='multi-scale testing sizes for corner or center Net. (point network)'
    )
