...
class ResNet(object):
    ...
    def layer_warp(self, input, stage_num, rfp_feat=None):
        ...
        conv = input
        for i in range(count):  # loop through num_bottleneck in one stage
            ...
            # only the first block of each stage contain feedback connection from fpn
